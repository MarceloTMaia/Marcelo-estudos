...
''')
          ...
          case '3': #----------------------------------------------------------- CASE 3 REMOVER OK
            ...
            encontrar_produto_apagar = int(encontrar_produto_apagar) #Se for um deigito ele converte para um numero inteiroddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
